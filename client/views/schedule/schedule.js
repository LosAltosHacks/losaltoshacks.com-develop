        ...
        days: [
            {
                ...
                scheduleItems: [
                    ...
                    {time: "4:30 PM", name: "Programming Robots and Working with Hardware (FIRST Robotics)", location:"Saturn"},
                    {time: "5:00 PM", name: "Cheater Cheater (Microsoft)", location:"Nebula"},
                    {time: "5:30 PM", name: "Dinner", location:"Cosmic Cafe"},
                    {time: "6:30 PM", name: "Intro to Git", location:"Saturn"},
                    {time: "7:00 PM", name: "Cup Stacking", location:"Cosmic Cafe"},
